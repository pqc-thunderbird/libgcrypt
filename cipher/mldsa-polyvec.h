...
int _gcry_mldsa_polyvecl_chknorm(gcry_mldsa_param_t *params, const gcry_mldsa_polyvec *v, int32_t B);
...
int _gcry_mldsa_polyveck_chknorm(gcry_mldsa_param_t *params, const gcry_mldsa_polyvec *v, int32_t B);
...
unsigned int _gcry_mldsa_polyveck_make_hint(gcry_mldsa_param_t *params, gcry_mldsa_polyvec *h,
                                const gcry_mldsa_polyvec *v0,
                                const gcry_mldsa_polyvec *v1);
void _gcry_mldsa_polyveck_use_hint(gcry_mldsa_param_t *params, gcry_mldsa_polyvec *w, const gcry_mldsa_polyvec *v, const gcry_mldsa_polyvec *h);
