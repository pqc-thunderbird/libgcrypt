...
#define pqcrystals_kyber512_90s_avx2_KEYPAIRCOINBYTES pqcrystals_kyber512_KEYPAIRCOINBYTES
#define pqcrystals_kyber512_90s_avx2_ENCCOINBYTES pqcrystals_kyber512_ENCCOINBYTES
#define pqcrystals_kyber512_90s_avx2_BYTES pqcrystals_kyber512_BYTES

int pqcrystals_kyber512_90s_avx2_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int pqcrystals_kyber512_90s_avx2_keypair(uint8_t *pk, uint8_t *sk);
int pqcrystals_kyber512_90s_avx2_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
...
#define pqcrystals_kyber768_90s_avx2_KEYPAIRCOINBYTES pqcrystals_kyber768_KEYPAIRCOINBYTES
#define pqcrystals_kyber768_90s_avx2_ENCCOINBYTES pqcrystals_kyber768_ENCCOINBYTES
#define pqcrystals_kyber768_90s_avx2_BYTES pqcrystals_kyber768_BYTES

int pqcrystals_kyber768_90s_avx2_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int pqcrystals_kyber768_90s_avx2_keypair(uint8_t *pk, uint8_t *sk);
int pqcrystals_kyber768_90s_avx2_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
...
#define pqcrystals_kyber1024_90s_avx2_KEYPAIRCOINBYTES pqcrystals_kyber1024_KEYPAIRCOINBYTES
#define pqcrystals_kyber1024_90s_avx2_ENCCOINBYTES pqcrystals_kyber1024_ENCCOINBYTES
#define pqcrystals_kyber1024_90s_avx2_BYTES pqcrystals_kyber1024_BYTES

int pqcrystals_kyber1024_90s_avx2_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int pqcrystals_kyber1024_90s_avx2_keypair(uint8_t *pk, uint8_t *sk);
int pqcrystals_kyber1024_90s_avx2_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
