 ...
 */
static void base_w(const _gcry_slhdsa_param_t *ctx, unsigned int *output, const int out_len,
...
static gcry_err_code_t wots_checksum(const _gcry_slhdsa_param_t *ctx, unsigned int *csum_base_w,
