...
unsigned int poly_make_hint(byte hint[GCRY_MLDSA_N], const gcry_mldsa_poly *a0, const gcry_mldsa_poly *a1);
...
void poly_uniform_gamma1(gcry_mldsa_poly *a, const byte seed[GCRY_MLDSA_CRHBYTES], uint16_t nonce);
void poly_challenge(gcry_mldsa_poly *c, const byte seed[GCRY_MLDSA_SEEDBYTES]);
...
void polyeta_pack(byte r[POLYETA_PACKEDBYTES], const gcry_mldsa_poly *a);
void polyeta_unpack(gcry_mldsa_poly *r, const byte a[POLYETA_PACKEDBYTES]);
...
void polyz_pack(byte r[POLYZ_PACKEDBYTES], const gcry_mldsa_poly *a);
void polyz_unpack(gcry_mldsa_poly *r, const byte *a);

void polyw1_pack(byte *r, const gcry_mldsa_poly *a);
